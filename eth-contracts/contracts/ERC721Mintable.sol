...
contract Pausable is Ownable{
    ...
    function setPausable(bool flag) public onlyOwner {
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId]!=to,"Cant transfer token to yourself");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function getBaseTokenURI(uint256 _tokenId) external view returns (string memory) {
    ...
    function setTokenUri(uint256 _tokenId) internal {
           ...
           string memory tokenString=uint2str(_tokenId);
          _tokenURIs[_tokenId]=strConcat(_baseTokenURI,tokenString);
 ...
 contract CustomERC721Token is ERC721Metadata{
     ...
     constructor() public ERC721Metadata("capstone","ACP","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/")
     {}
